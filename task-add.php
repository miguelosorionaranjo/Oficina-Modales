...
if(isset($_POST['csoat'])) {
  ...
  $query = "INSERT into pesv(clicencia, csoat, crtm, crc, cdelanteras, ctraseras, caltass, cbajass, cstop,
                              creversa, cparqueo, cdia, cprincipal, cemergencia, cddelanteras, cttraseras,
                              crepuesto, cderecho, cizquierdo, cretrovisor, cbocina, cfrenos, caceite,
                              crefrigerante, cdelan, ctras, ccinturones, ca, sincronizacion, ab, cll,
                              rtmecanica, casoat, fv, ecapacidad, calicates, cdestorni, cle, clf, ccruceta,
                              cgh, ctaco, csenal, cchaleco, cbotiquin) VALUES 
  ('$task_clicencia','$task_csoat', '$task_crtm', '$task_crc', '$task_cdelanteras', '$task_ctraseras', 
  '$task_caltass', '$task_cbajass',  '$task_cstop', '$task_creversa', '$task_cparqueo', '$task_cdia', 
  '$task_cprincipal', '$task_cemergencia', '$task_cddelanteras', '$task_cttraseras', '$task_crepuesto',
  '$task_cderecho','$task_cizquierdo','$task_cretrovisor','$task_cbocina','$task_cfrenos','$task_caceite',
  '$task_crefrigerante', '$task_cdelan','$task_ctras','$task_ccinturones', '$task_ca', '$task_sincronizacion',
  '$task_ab','$task_cll','$task_rtmecanica', '$task_casoat','$task_fv','$task_ecapacidad', '$task_calicates',
  '$task_cdestorni','$task_cle','$task_clf', '$task_ccruceta', '$task_cgh', '$task_ctaco',
  '$task_csenal','$task_cchaleco','$task_cbotiquin',)";
